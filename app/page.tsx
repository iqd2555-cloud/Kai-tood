        ...
        <div className="grid gap-5 lg:grid-cols-2">
          {franchiseModels.map((model, index) => (
            <article key={model.title} className="flex flex-col overflow-hidden rounded-[2rem] border border-[#eadfca] bg-[#fff8ed] text-[#151515] shadow-xl shadow-black/8">
              ...
              <div className={index === 0 ? "flex min-h-[25rem] w-full items-center justify-center bg-white p-1 sm:min-h-[32rem] lg:min-h-[34rem]" : "flex h-72 items-center justify-center bg-white p-4 sm:h-80"}><img src={model.imageSrc} alt={model.imageAlt} className={index === 0 ? "h-full min-h-[24.5rem] w-full rounded-[1.5rem] object-contain sm:min-h-[31.5rem] lg:min-h-[33.5rem]" : "h-full w-full rounded-[1.5rem] object-contain"} /></div>
