...
create table public.daily_reports (
  ...
  order_wrapping_paper numeric not null default 0 check (order_wrapping_paper >= 0),
  order_plastic_bag numeric not null default 0 check (order_plastic_bag >= 0),
  order_tom_yum_powder numeric not null default 0 check (order_tom_yum_powder >= 0),
  order_cheese_powder numeric not null default 0 check (order_cheese_powder >= 0),
  order_paprika_powder numeric not null default 0 check (order_paprika_powder >= 0),
  order_wing_zabb_powder numeric not null default 0 check (order_wing_zabb_powder >= 0),
  order_hot_spicy_powder numeric not null default 0 check (order_hot_spicy_powder >= 0),
