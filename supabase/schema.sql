...
create table public.daily_reports (
  ...
  used_bl numeric not null default 0,
  used_bb numeric not null default 0,
  used_chicken_skin numeric not null default 0,
  used_oil numeric not null default 0,
  used_sticky_rice numeric not null default 0,
  used_chopped_chicken numeric not null default 0,
  used_drumstick numeric not null default 0,
  used_offal numeric not null default 0,
...
create table public.cash_flow_entries (
  ...
  source_ref text,
  attachment_url text,
  document_type text default 'no_document',
  accountant_note text default '',
