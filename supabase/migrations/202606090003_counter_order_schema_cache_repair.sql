-- Repair Counter Order objects that can be absent from older production databases.
-- This migration is intentionally idempotent and ends with a PostgREST schema reload.
