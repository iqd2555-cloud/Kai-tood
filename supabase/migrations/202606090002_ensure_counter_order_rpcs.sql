-- Ensure Staff Counter Order database objects and RPC functions exist in production.
-- Safe to run multiple times in Supabase SQL Editor on an existing project.
