...
const APP_SHELL = ["/manifest.webmanifest", "/kaitoodlogo.jpeg", "/icons/icon-192.svg", "/icons/icon-512.svg"];
const NO_STALE_PATHS = ["/login", "/dashboard", "/owner-dashboard", "/cash-flow", "/daily", "/api/cash-flow"];
const STATIC_CACHE_PATHS = ["/_next/static/", "/icons/", "/kaitoodlogo.jpeg"];
